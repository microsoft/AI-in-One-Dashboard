...
$siteId = "m365cpi94179096.sharepoint.com,796935a2-1fec-4d0d-a105-7b5a6d01deb8,30b0a905-d657-4161-adad-e955cd60b678" # 👈 Update with actual Site ID
$displayName = "AI in One Dashboard Automation Account"
$resourceGroup = "abv-bicep-validation-rg" # 👈 Update with actual Resource Group name
