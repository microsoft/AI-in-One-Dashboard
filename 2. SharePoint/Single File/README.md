...
| Item | Purpose |
|---|---|
| `AI-in-One Dashboard.pbit` | Power BI template (NatWest pre-parsed format). Open in Power BI Desktop, fill in parameters, publish to Service. |
...
2. *(wait ~30 mins)*
3. **`GetCopilotInteractions-SP-AppReg.ps1`** — fetches results, applies NatWest 15-column flattening, uploads CSV to SharePoint
